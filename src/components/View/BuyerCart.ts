...
export class BuyerCart extends Component<CartView> {
    ...
    private readonly totalElements: HTMLElement;

    constructor(container: HTMLElement, private readonly eventEmitter: IEvents) {
        super(container);
        this.list = ensureElement<HTMLElement>(".basket__list", this.container);
        this.orderButton = ensureElement<HTMLButtonElement>(".basket__button", this.container);
        this.totalElements = ensureElement<HTMLElement>(".basket__price", this.container);
    ...
    set total(value: number) {
        this.setText(this.totalElements, `${value} синапсов`);
    }
